...
>
    ...
    <div class="flex items-center justify-center md:hidden">
        <template x-for="page in pagesInRangeForSmallScreen" :key="page.number">
    ...
    <template x-if="totalPages > 8">
        <div class="hidden w-[360px] items-center justify-center md:flex">
            ...
            <template x-if="showMiddlePages">
                ...
                >
                    <div class="text-lg tracking-wide transition duration-300 group-hover:opacity-0">...</div>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
            ...
            <template x-for="page in pagesInRange" :key="page.number">
                <x-he4rt::pagination-button />
            </template>
