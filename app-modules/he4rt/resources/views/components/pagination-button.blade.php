<div
    class="mx-0.5 flex min-h-9 min-w-9 cursor-pointer items-center justify-center rounded-xl text-sm text-neutral-700 transition-all duration-300 select-none active:scale-90"
    :class="{
